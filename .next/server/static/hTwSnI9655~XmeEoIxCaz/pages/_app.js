...
// CONCATENATED MODULE: ./lib/updateObject.js
...
var store_reducer = function reducer() {
  ...
  switch (action.type) {
    case actionType["b" /* CHANGE_COlOR_BLUE */]:
    ...
    case actionType["d" /* CHANGE_COlOR_YELLOW */]:
      return updateObject(state, {
        color: action.yellow,
    ...
    case actionType["c" /* CHANGE_COlOR_GREY */]:
      return updateObject(state, {
        color: action.grey,
    ...
    case actionType["a" /* CHANGE_COlOR_AFTER_RE */]:
      return updateObject(state, {
